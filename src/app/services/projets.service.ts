  ...
  projets: Projet[] = [
      {
        ...
        description : "Jeu, auquel j'ai mis 2 ans, entre 14-16ans à développer ce jeu dans mon temps libre sur scratch",
      ...
      },
      {
        ...
        description : "Je possède une commaunuté Minecraft autour de Dragon Ball Z, j'ai décider faire un bot pour rendre tout plus simple à effectuer dans mon serveur et autre aide, tout fait à la main",
